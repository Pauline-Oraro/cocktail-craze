...
const About = () => {
    useGSAP(() => {
        ...
        scrollTimeline.from(titleSplit.words, {opacity: 0, duration: 1, yPercent: 100, ease: 'expo.out' , stagger: 0.02})

        scrollTimeline.from('.top-grid div, .bottom-grid div', {opacity: 0, duration: 1, ease: 'power1.inOut', stagger: 0.04}, '-=0.5')
    })
  return (
    <div id='about'>
      <div className='mb-16 md:px-0 px-5'>
        <div className='content'>
            ...
            <div className='md:col-span-8'>
                ...
                <h2>Where every detail matters <span className='text-white'>from muddle to garnish</span></h2>
            </div>
